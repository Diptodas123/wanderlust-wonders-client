    ...
    return (
        <>
            ...
            <div>
                ...
                <div id="domestic-carousel" class="carousel slide mt-5" data-ride="carousel" style={{ objectFit: 'cover' }}>
                    <div class="carousel-inner slider-img">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="img/banner.jpg" height={'300px'} alt="First slide" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="img/banner2.jpg" height={'300px'} alt="Second slide" />
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="img/banner3.jpg" height={'300px'} alt="Third slide" />
                        </div>
                    </div>
                    ...
                    <div class="dropdown-domestic">
                        <div className="row">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <button class="dropdown-item" type="button" onClick={() => setItem(Dom)}>All</button>
